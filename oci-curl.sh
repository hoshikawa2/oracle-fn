...
# If your key file has a passphrase, please set the env variable OCI_CURL_PRIVATE_KEY_PASSPHRASE with the
# passphrase before running the script

function oci-curl {
	# TODO: update these values to your own
        local tenancyId="ocid1.tenancy.oc1..aaaaaaaarmf64ufoolro2kzrupzyazqycjapqsyacn7rju64jyw4zbyb6j6q";
        local authUserId="ocid1.user.oc1..aaaaaaaa5qt6x2bhe3pqawphnt75xtdpmntisfgxeizqsol4f3kxmlcmphda";
        local keyFingerprint="34:36:4e:62:0c:c3:1f:80:5b:b0:18:80:d5:e9:73:1c";
        local privateKeyPath="/home/opc/OKE/oci_api_key.pem";
